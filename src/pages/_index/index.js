...
export const articleData = [
  {
    ...
    articleText:
      "Actuellement à la recherche d’une alternance, ou à défaut d'un stage de 2 mois dans l’industrie du web.\r\n\nQuand ? En cas d'alternance, en aout 2020 pour une durée de 2 ans. Et en cas de stage, en aout 2020 pour une durée de 2 mois. Le rythme de l’alternance serait de 3 semaines en entreprise pour 1 semaine de formation.\r\n\nJe suis intéressée par l’idée de travailler dans le domaine de la programmation.\r\n\nAvant tout, je suis à la recherche d’une entreprise dans laquelle le travail d’équipe, l’entente et le respect des valeurs humaines sont centraux afin que je puisse m’épanouir tant sur le plain humain que professionnel. ",
  ...
  },
  {
    ...
    articleText:
      "- Figma : Maitrise du logiciel grâce à des projets comme ce portfolio, où je m’occupe du maquettage. C’est un domaine qui me plait. J’ai aussi eu l’occasion  d’utiliser des plugins. Maitrise de l’option de prototypage sur ce logiciel. \r\n\n- Photoshop et Illustrator : Des cours de qualité durant toute l’année m’ont permis de maitriser ces logiciels.\r\n\n- Premiere pro : j’ai montée de courtes videos de maquillage artistique sur ce logiciel.",
  ...
  },
  {
    ...
    articleText:
      "Durant un projet à l’école, avec une équipe, l’objectif était d’inventer un jeu vidéo sur le thème “après” entièrement codé en JavaScript (dans un délais de seulement 5 jours).\r\n\nPuis par la suite j’ai decidé de reprendre le projet et de l’améliorer. Le design à entièrement était fait par moi ainsi qu'une grande partie du code. Ce projet m’a apporté de nombreuses connaissances en JavaScript.",
